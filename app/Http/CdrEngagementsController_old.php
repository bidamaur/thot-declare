...
WHEN (SELECT MAX(num) FROM bkechprt where eve=e.eve AND ave=(SELECT MAX(ave) FROM bkechprt  WHERE eve=e.eve) )=e.num THEN '02'
WHEN (SELECT max(ctr) from bkechprt where eve=e.eve AND ave=(SELECT MAX(ave) FROM bkechprt  WHERE eve=e.eve) AND ( cdr_date(dva) 
